        ...
        <>
            <div>
                <header className="login_header">
                    <Link href="/register" className="login_header_link_full">
                        Cadastre-se
                    </Link>
                    <Link href="/login" className="login_header_link_outline">
                        Entrar
                    </Link>
                </header>
                <main className="login_main">
                    <h1 className="login_title">Bem vindo novamente!</h1>
                    ...
                    <form className="login_form">
                        <div className="login_form_pt1">
                            ...
                            <div className="login_password_align">
                                ...
                                <Link href="/user/forgotPassword" className="login_forgot_password">Esqueceu sua senha?</Link>
                            </div>
                        </div>
